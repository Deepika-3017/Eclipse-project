...
public class User {
	...
	public void destroy() throws Exception {
		System.out.println("destroy() method DisposableBean interface is executed");
		
	}
	public void afterPropertiesSet() throws Exception {
		System.out.println("afterPropertiesSet() method of InitializingBean interface is executed");
	}
}
